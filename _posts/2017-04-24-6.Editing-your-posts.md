...
<p>After you have edited your posts, to commit changes in Git, firstly choose "save all" under open editors found on the explorer tab on the right side.</p>
...
<ol>
  ...
  <li>git push: <i>to push the changes too github</i></li>
</ol>
